...
//        animalTypeRepository.save(new AnimalType(1L, false, "cat"));
//        animalTypeRepository.save(new AnimalType(2L, false, "dog"));
//        animalTypeRepository.save(new AnimalType(3L, true, "wolf"));
//        animalTypeRepository.save(new AnimalType(4L, true, "shark"));
//    }
